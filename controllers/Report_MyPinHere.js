...
function SetSpeedValue(Speed, SpeedValue) {
    var Speed = parseFloat(Speed);
    if (SpeedValue == 'KPH') {
        return Speed.toFixed(2) + ' km/h';
    } else if (SpeedValue == 'MPH') {
        Speed = (Speed) * 0.621372;
        return Speed.toFixed(2) + ' m/h';
    } else {
        return Speed.toFixed(2) + ' km/h';
    }
}

function SetSpeedValueWithoutSymbol(Speed, SpeedValue) {
    var Speed = parseFloat(Speed);
    if (SpeedValue == 'KPH') {
        return Speed;
    } else if (SpeedValue == 'MPH') {
...
function SetkmValue(kmdata, IsRound, SpeedValue) {
    var kmdata = parseFloat(kmdata);
    if (SpeedValue == 'KPH') {
        if (IsRound == false) {
            return kmdata.toFixed(2) + ' km';
        } else {
            return Math.floor(kmdata) + ' km';
        }
    } else if (SpeedValue == 'MPH') {
        kmdata = parseFloat(kmdata) * 0.621372;
        if (IsRound == false) {
            return kmdata.toFixed(2) + ' mi';
        } else {
            return Math.floor(kmdata) + ' mi';
        }
    } else {
        if (IsRound == false) {
            return kmdata.toFixed(2) + ' mi';
    ...
    connectionreport.query(query, function(err, response) {
        ...
        for (var i = 0; i < response.length; i++) {
            ...
            if (response[i].Latitude != undefined && response[i].Latitude != null && response[i].Latitude != '' && response[i].Longitude != undefined && response[i].Longitude != null && response[i].Longitude != '') {
                ...
                // if (req.query.SpeedValue == 'KPH') {
                //     Speed = Speed.toFixed(2) + ' km/h';
                // }
                // if (req.query.SpeedValue == 'MPH') {
                //     Speed = (Speed) * 1000;
                //     Speed = Speed.toFixed(2) + ' m/h';
                // }

                Speed = SetSpeedValue(Speed, req.query.SpeedValue);
                Mileage = SetkmValue(Mileage, false, req.query.SpeedValue);
            ...
            if (response.length > 0) {
                ...
                function GetData(i) {
                    ...
                    if (i < Array.length) {
                        ...
                        //     AverageSpeed = AverageSpeed.toFixed(2) + ' m/h';

                        //     HighestSpeed = (HighestSpeed) * 1000;
                        //     HighestSpeed = HighestSpeed.toFixed(2) + ' m/h';
                        // }
                        ...
                        AverageSpeed = SetSpeedValue(AverageSpeed, req.query.SpeedValue);
                        HighestSpeed = SetSpeedValue(HighestSpeed, req.query.SpeedValue);
                        Mileage = SetkmValue(Mileage, false, req.query.SpeedValue);
        ...
        connectionreport.query(query1, function(alarmerr, alarmresponse, alarmfields) {
            ...
            if (response.length > 0) {
                ...
                var table = '<div style="font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; font-size: 10px; padding:0 15px;">' +
                    ...
                    '<th style="border-bottom: 1px dotted #000;font-size:10px;font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; border-right: 1px dotted #000;">Average Speed</th>' +
                        ...
                        for (var k = 0; k < lstGroup[i].data.length; k++) {
                            ...
                            if (lstGroup[i].data[k].IsEngine == true) {
                                if (lstGroup[i].data[k].Speed > 1 && lstGroup[i].data[k].GPSPositioning == 'A') {
                                    ...
                                    if (req.query.SpeedValue == 'MPH') {
                                        if (SetSpeedValueWithoutSymbol(lstGroup[i].data[k].Speed, req.query.SpeedValue) > 30 && SetSpeedValueWithoutSymbol(lstGroup[i].data[k].Speed, req.query.SpeedValue) <= 50) {
                                            Speed6090 = Speed6090 + 1;
                                        }
                                        if (SetSpeedValueWithoutSymbol(lstGroup[i].data[k].Speed, req.query.SpeedValue) > 50 && SetSpeedValueWithoutSymbol(lstGroup[i].data[k].Speed, req.query.SpeedValue) <= 80) {
                                            Speed90130 = Speed6090 + 1;
                                        }
                                        if (SetSpeedValueWithoutSymbol(lstGroup[i].data[k].Speed, req.query.SpeedValue) > 80) {
                                            Over130 = Over130 + 1;
                                        }
                                    } else {
...
router.get('/ExportDriverReport', function(req, res) {
    ...
    if (req.query.SpeedValue == 'MPH') {
        var Caption6090speed = "30-50 Speed (m/h)";
        var Caption90130speed = "50-80 Speed (m/h)";
        var Caption130speed = "Over 80 Speed (m/h)";
    } else {
        var Caption6090speed = "60-90 Speed (km/h)";
        var Caption90130speed = "90-130 Speed (km/h)";
        var Caption130speed = "Over 130 Speed (km/h)";
    }
    ...
    conf.cols = [{
        ...
        // },
        {
            ...
            caption: Caption6090speed,
            type: 'string'
        }, {
            caption: Caption90130speed,
            type: 'string'
        }, {
            caption: Caption130speed,
            type: 'string'
        }, {
            caption: 'Max Speed',
            type: 'number'
            ...
            if (response.length > 0) {
                ...
                function GetDrivingData(i) {
                    ...
                    if (i < Array.length) {
                        ...
                        MaxSpeed = SetSpeedValue(MaxSpeed, req.query.SpeedValue);
                        avgSpeed = SetSpeedValue(avgSpeed, req.query.SpeedValue);
                        StartSpeed = SetkmValue(StartSpeed, false, req.query.SpeedValue);
        ...
        connectionreport.query(query1, function(alarmerr, alarmresponse, alarmfields) {
            if (response.length > 0) {
                ...
                var table = '<div style="font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; font-size: 10px; padding:0 15px;">' +
                    ...
                    '<th style="border-bottom: 1px dotted #000;font-size:10px;font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; border-right: 1px dotted #000;">End Time</th>' +
                    '<th style="border-bottom: 1px dotted #000;font-size:10px;font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; border-right: 1px dotted #000;">Driving Time</th>' +
                    '<th style="border-bottom: 1px dotted #000;font-size:10px;font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; border-right: 1px dotted #000;">' + Caption6090speed + '</th>' +
                    '<th style="border-bottom: 1px dotted #000;font-size:10px;font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; border-right: 1px dotted #000;">' + Caption90130speed + '</th>' +
                    '<th style="border-bottom: 1px dotted #000;font-size:10px;font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; border-right: 1px dotted #000;">' + Caption130speed + '</th>' +
                    '<th style="border-bottom: 1px dotted #000;font-size:10px;font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif; border-right: 1px dotted #000;">Max Speed</th>' +
    ...
    connectionreport.query(query, function(err, response, fields) {
        ...
        connectionreport.query(query1, function(alarmerr, alarmresponse, alarmfields) {
            ...
            for (var i = 0; i < response1.length; i++) {
                ...
                response1[i].AverageSpeed = SetSpeedValue(response1[i].AverageSpeed, req.query.SpeedValue);
                response1[i].HighestSpeed = SetSpeedValue(response1[i].HighestSpeed, req.query.SpeedValue);
                response1[i].TotalMileage = SetkmValue(response1[i].TotalMileage, false, req.query.SpeedValue);
        ...
        connectionreport.query(query1, function(alarmerr, alarmresponse, alarmfields) {
            ...
            var lstGroup = u.map(GroupByDevice, function(group, DeviceId) {
                ...
                return {
                    ...
                    HighestSpeed: HighestSpeed.toFixed(2),
                    TotalMileage: TotalMileage.toFixed(2) + " km",
                    OverSpeed: OverSpeed,
                    TotalTiming: TotalTimingDisplay,
                }
            ...
            for (var i = 0; i < response1.length; i++) {
                var row = [];
                // if (req.query.SpeedValue == 'KPH') {
                //     response1[i].AverageSpeed = response1[i].AverageSpeed.toFixed(2) + ' km/h';
                //     response1[i].HighestSpeed = response1[i].HighestSpeed.toFixed(2) + ' km/h';
                // }
                // if (req.query.SpeedValue == 'MPH') {
                //     response1[i].AverageSpeed = (response1[i].AverageSpeed) * 1000;
                //     response1[i].AverageSpeed = response1[i].AverageSpeed.toFixed(2) + ' m/h';

                //     response1[i].HighestSpeed = (response1[i].HighestSpeed) * 1000;
                //     response1[i].HighestSpeed = response1[i].HighestSpeed.toFixed(2) + ' m/h';
                // }
                response1[i].AverageSpeed = SetSpeedValue(response1[i].AverageSpeed, req.query.SpeedValue);
                response1[i].HighestSpeed = SetSpeedValue(response1[i].HighestSpeed, req.query.SpeedValue);
                response1[i].TotalMileage = SetkmValue(response1[i].TotalMileage, false, req.query.SpeedValue);
...
router.get('/PrintJourneyReport', function(req, res) {
    ...
    connectionreport.query(query, function(err, response, fields) {
        ...
        connectionreport.query(query1, function(alarmerr, alarmresponse, alarmfields) {
            ...
            for (var i = 0; i < response1.length; i++) {
                // if (req.query.SpeedValue == 'KPH') {
                //     response1[i].AverageSpeed = parseFloat(response1[i].AverageSpeed).toFixed(2) + ' km/h';
                //     response1[i].HighestSpeed = parseFloat(response1[i].HighestSpeed).toFixed(2) + ' km/h';
                // }
                // if (req.query.SpeedValue == 'MPH') {
                //     response1[i].AverageSpeed = parseFloat(response1[i].AverageSpeed) * 1000;
                //     response1[i].AverageSpeed = response1[i].AverageSpeed.toFixed(2) + ' m/h';

                //     response1[i].HighestSpeed = parseFloat(response1[i].HighestSpeed) * 1000;
                //     response1[i].HighestSpeed = response1[i].HighestSpeed.toFixed(2) + ' m/h';
                // }
                response1[i].AverageSpeed = SetSpeedValue(response1[i].AverageSpeed, req.query.SpeedValue);
                response1[i].HighestSpeed = SetSpeedValue(response1[i].HighestSpeed, req.query.SpeedValue);
