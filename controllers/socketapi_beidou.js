...
global.SendSpeedDataBeidou = function (objdata, Callback) {
  ...
  var Speed = ('00000000' + decimalToHexString(parseInt(objdata.Speed))).slice(
    -8
  );
...
global.SetOdometerSettingBeidou = function (objdata, Callback) {
  ...
  var Odometer = (
    '00000000' + decimalToHexString(parseInt(objdata.odometer))
  ).slice(-8);
